            ...
            <div class="input-group">
                <div class = "inp-row">
                    <div class="input-field">
                        <p>First Name</p>
                        <input id="first_name" type="text"value="88daada8" required />
                    </div>
                    <div class="input-field">
                        <p>Last Name</p>
                        <input id="last_name" type="text" value="adad" required />
                    </div>
                </div>
                ...
                <div class = "inp-row">
                    <div class="input-field">
                        <p>Email</p>
                        <input id="email" type="email" value="a@gmail.com" required />
                    </div>
                    <div class="input-field">
                        <p>Middle Name</p>
                        <input id="middle_name" type="text"  value="qeqeqeq" required />
                    </div>
                </div>
                ...
                <div class="input-field">
                        <p>Phone Number</p>
                        <input id="phone_number" type="tel" value="88888888888" required />
                    </div>
                    
                
                    <div class="input-field">
                        <p>Government Id</p>
                        <input id="government_id" type="number" value="12" required />
                    </div>
                </div>
                ...
                <div class = "inp-row under">
                    ...
                    <div class="input-field">
                        <p>Password</p>
                        <input id="password" type="text" value="13111313" required />
                    </div>
                </div>
...
$addButton.onclick = async function () {
    ...
    resp_roles.forEach((oneinstance) => {
        if (oneinstance.name == "driver") {
            driverID = oneinstance._id;
        }
    });
    ...
    save.onclick = async function () {
        if (
            ...
            const address =
                city.value + " " + house_number.value + " " + street.value;
            console.log(address);
