const users = [
    { type: "driver", value: "Fuelings" },
    { type: "button", value: "+ Add Fueling" },
];

const cols = [
    { type: "ID", value: "ID" },
    { type: "ID", value: "FuelerID" },
    { type: "names", value: "VehicleID" },
    { type: "surname", value: "FuelAmount" },
...
function button(block) {
    return `
    <button type="button" class="add-button" onclick="location.href = '/form.html';">
        <p>${block.value}</p>
    </div>
`;
}
